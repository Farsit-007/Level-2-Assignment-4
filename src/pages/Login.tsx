      ...
      <div className="group mx-auto flex w-full items-center max-w-3xl border border-black bg-white  shadow-lg ">
        ...
        <form className="flex-1 p-8" onSubmit={handleSubmit}>
          <div className="flex justify-between items-center">
            ...
            <Link
              to={"/"}
              className="flex  font-medium bg-black text-white transition-all duration-300 p-1 px-2 hover:bg-[#f7c788] hover:text-black rounded-md items-center cursor-pointer gap-2"
            >
              Back To Home
            </Link>
          </div>
